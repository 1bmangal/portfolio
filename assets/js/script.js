...
const toggleSlider = () =>{
    ...
    //captura o slider pelo id, separando slider e o numero
    let id=parseInt(current.getAttribute('id').
            split('-')[1]);
    ...
    for(let slider of slides) slider.
        removeAttribute('checked');
    //marca o proximo slider pelo id
